...
class Presets(loader.Module):
    """Suggests new Shaxsiy users a packs of modules to load"""
    ...
    strings_uz = {
        ...
        "_chat_title": "👥 Chatni boshqarish modullari",
        "_chat_desc": (
            "Chatni boshqarish modullari uchun yordam beruvchi koleksiya ham mavjud —"
            " filtrlar, qaydlar, tilni aniqlash, va boshqa."
        ),
