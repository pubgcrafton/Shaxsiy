...
class APIRatelimiterMod(loader.Module):
    ...
    strings_uz = {
        "warning": (
            ...
            " imkoniyat berishga o'xshaydi, unda faqat blokirovkani to'xtatish uchun"
        ...
        "u_sure": (
            "<emoji document_id=6319093650693293883>☣️</emoji> <b>Sizning"
    ...
    async def _install_protection(self):
        ...
        self._client._call._shaxsiy_overwritten = True
