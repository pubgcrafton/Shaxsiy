...
class OktetoMod(loader.Module):
    """Helps Shaxsiy to stay awake on Okteto"""

    strings = {"name": "Okteto"}
    strings_ru = {"_cls_doc": "Помогает Shaxsiy оставаться активной на Okteto"}
    strings_de = {"_cls_doc": "Hilft Shaxsiy, auf Okteto wach zu bleiben"}
    strings_uz = {"_cls_doc": "Oktetoda Shaxsiy userbotni faol bo'lishida yordam beradi"}
    strings_hi = {"_cls_doc": "Okteto पर Shaxsiy को जागा रखने में मदद करता है"}
    strings_tr = {"_cls_doc": "Shaxsiy'nın Okteto'da aktif kalmasını sağlar"}
    strings_ja = {"_cls_doc": "OktetoでShaxsiyを起こすのを助けます"}
    strings_kr = {"_cls_doc": "Okteto에서 Shaxsiy를 깨우는 데 도움이됩니다"}
    strings_ar = {"_cls_doc": "يساعد هيكا على البقاء مستيقظًا على Okteto"}
    strings_es = {"_cls_doc": "Ayuda a Shaxsiy a quedarse despierto en Okteto"}
