...
class QuickstartMod(loader.Module):
    ...
    strings = {
        "name": "Quickstart",
        "base": """🔰🇬🇧 <b>Hello.</b> You've just installed <b>Shaxsiy</b> userbot.
...
📣 <b>Check out community made channels with modules: <a href="https://t.me/shaxsiy_userbot/8">show</a></b>
...
💡 <b>Shaxsiy supports modules from Friendly-Telegram and GeekTG, as well as its own ones.</b>""",
        "okteto": (
        ...
        "railway": (
            ...
            " <b>Shaxsiy will be frozen</b>. Next month <b>you will need to go to"
    ...
    strings_ru = {
        "base": """🔰🇷🇺 <b>Привет.</b> Твой юзербот <b>Shaxsiy</b> установлен.
...
📣 <b>Загляни в каналы с модулями, созданными комьюнити: <a href="https://t.me/shaxsiy_userbot/8">показать</a></b>
...
💡 <b>Shaxsiy поддерживает модули из Friendly-Telegram и GeekTG, а также свои собственные.</b>
""",
        "okteto": (
    ...
    strings_de = {
        "base": """🔰🇩🇪 <b>Hallo.</b> Dein Userbot <b>Shaxsiy</b> ist installiert.
...
💡 <b>Shaxsiy unterstützt Module von Friendly-Telegram und GeekTG sowie eigene Module.</b>
""",
        "okteto": (
    ...
    strings_uz = {
        "base": """🔰🇺🇿 <b>Salom.</b> <b>Shaxsiy</b> Sizning foydalanuvchi botingiz sozlandi.

❓ <b>Yordam kerakmi?</b> Siz bizning qo'llab-quvvatlash guruhimizga qo'shilishingiz mumkin. guruhimzda  <b>barcha savollaringizga javob olasiz</b>.

📼 <b>Modullar @hikkamods_bot ushbu botimiz orqali siz har qanday userbotga tegishli bo'lgan modullarni o'rnatishingiz mumkun botga kalit so'zni yuboring va  ⛩ O'rnatish tugmasini bosing</b>

📣 <b>Homiylar tomonidan yaratilgan modullar kanalini ko'rish: <a href="https://t.me/shaxsiy_userbot/8">kanalni ko'rish</a></b>
...
💡 <b>Shaxsiy Userbot Friendly-Telegram , GeekTG va o'z Modullarini qo'llab-quvvatlaydi.</b>
""",
        "okteto": (
        ...
        "railway": (
            "🚂 <b>Sizning userbotingiz Railwayda o'rnatilgan</b>. Bu platforma,"
            " <b>oyiga atigi 500 soat bepul jihati</b> Railway bergan muddat tugagandan"
            " so'ng sizning botingiz  <b>to'xtatiladi</b>. Keyingi oy,"
            " https://railway.app havolasi orqali userbotingizni qayta ishga tushira"
            " olasiz.</b>"
        ),
    ...
    strings_tr = {
        "base": """🔰🇹🇷 <b>Merhaba.</b> <b>Shaxsiy</b> kullanıcı botunuz kuruldu.
...
📣 <b>Topluluk tarafından oluşturulan modül kanalları görüntüleyin: <a href="https://t.me/shaxsiy_userbot/8">göster</a></b>
...
💡 <b>Shaxsiy Friendly-Telegram ve GeekTG modüllerini de dahil olmak üzere kendi modüllerini destekler.</b>
""",
        "okteto": (
    ...
    strings_hi = {
        "base": """🔰🇮🇳 <b>नमस्ते.</b> आपका <b>Shaxsiy</b> उपयोगकर्ता बॉट स्थापित किया गया है.
...
📣 <b>समुदाय द्वारा बनाए गए चैनल देखें: <a href="https://t.me/shaxsiy_userbot/8">दिखाएं</a></b>
...
💡 <b>अपने मॉड्यूल को समर्थित करने के लिए, Shaxsiy Friendly-Telegram और GeekTG मॉड्यूल भी शामिल हैं.</b>
""",
        "okteto": (
...
📣 <b>コミュニティで作成されたチャンネルを見るには、こちらをクリックしてください: <a href="https://t.me/shaxsiy_userbot/8">表示</a></b>
...
💡 <b>モジュールをサポートするには、Shaxsiy Friendly-Telegram と GeekTG モジュールも含まれています。</b>
""",
        "okteto": (
...
📣 <b>커뮤니티에서 생성된 채널을 보려면 여기를 클릭하십시오: <a href="https://t.me/shaxsiy_userbot/8">보기</a></b>
...
💡 <b>모듈을 지원하려면 Shaxsiy Friendly-Telegram 및 GeekTG 모듈도 포함됩니다.</b>
""",
        "okteto": (
...
📣 <b>لمشاهدة قنوات المجتمع التي تم إنشاؤها، انقر هنا: <a href="https://t.me/shaxsiy_userbot/8">عرض</a></b>
...
💡 <b>لدعم الوحدات، يتضمن Shaxsiy Friendly-Telegram و GeekTG أيضًا.</b>
""",
        "okteto": (
...
📣 <b>Para ver los canales de la comunidad creados, haga clic aquí: <a href="https://t.me/shaxsiy_userbot/8">Ver</a></b>
...
💡 <b>Para admitir módulos, también incluye Shaxsiy Friendly-Telegram y GeekTG.</b>
""",
        "okteto": (
                ...
                [
                    {
                        ...
                        "url": "https://t.me/shaxsiy_guruh_007",
                    }
                ],
            ]
            + [
