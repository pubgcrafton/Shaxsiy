...
class TestMod(loader.Module):
    ...
    strings = {
        ...
        "logs_caption": (
            "<emoji document_id=5188377234380954537>💢</emoji> <b>Shaxsiy logs with"
            " verbosity </b><code>{}</code>\n\n<emoji"
            " document_id=5454390891466726015>👋</emoji> <b>Shaxsiy version:"
    ...
    strings_de = {
        ...
        "logs_filename": "shaxsiy-logs.txt",
        "logs_caption": (
            "<emoji document_id=5188377234380954537>💢</emoji> <b>Shaxsiy-Level-Protokolle"
            " </b><code>{}</code>\n\n<emoji document_id=5454390891466726015>👋</emoji>"
            " <b>Shaxsiy-Version: {}.{}.{}</b>{}\n<Emoji"
    ...
    strings_uz = {
        "set_loglevel": "🚫 <b>Jurnal darajasini raqam yoki satr sifatida ko'rsating</b>",
        "no_logs": "ℹ️ <b>Siz {} darajadagi hech qanday jurnallaringiz yo'q.</b>",
        "logs_filename": "shaxsiy-logs.txt",
        "logs_caption": (
            "<emoji document_id=5188377234380954537>💢</emoji> <b>Shaxsiy Userbot Jurnallari"
            " </b><code>{}</code>\n\n<emoji document_id=5454390891466726015>👋</emoji>"
            " <b>Shaxsiy-versiyasi: {}.{}.{}</b>{}\n<Emoji"
        ...
        "debugging_enabled": (
            ...
            "`{0}.py` faylini o'zgartiring va o'zgarishlarni real vaqtda ko'ring</i>",
        ),
        ...
        "confidential": (
            "⚠️ <b>Jurnal darajasi </b><code>{}</code><b> shaxsiy ma'lumotlarga ega"
            " bo'lishi mumkin. O'zingizni xavfsizligingiz uchun</b>"
        ),
        "confidential_text": (
            "⚠️ <b>Jurnal darajasi </b><code>{0}</code><b> shaxsiy ma'lumotlarga ega"
            " bo'lishi mumkin. O'zingizni xavfsizligingiz uchun</b>\n<b>Yozing"
            " </b><code>.logs {0} force_insecure</code><b> jurnallarni Ogohlantirish</b>"
        ),
        "choose_loglevel": "💁‍♂️ <b>Jurnal darajasini tanlang</b>",
        "_cmd_doc_dump": "Xabar haqida ma'lumotlarni ko'rsatish",
        "_cmd_doc_logs": (
            "<Ebene> - Jurnal faylini yuboradi. O'rin darajalari xavfsizlik ma'lumotlari."
        ),
    ...
    strings_tr = {
        ...
        "logs_filename": "shaxsiy-logs.txt",
        "logs_caption": (
            "<emoji document_id=5188377234380954537>💢</emoji> <b>Shaxsiy Günlükleri"
            " </b><code>{}</code>\n\n<emoji document_id=5454390891466726015>👋</emoji>"
            " <b>Shaxsiy versiyası: {}.{}.{}</b>{}\n<Emoji"
    ...
    strings_hi = {
        ...
        "logs_filename": "shaxsiy-logs.txt",
        "logs_caption": (
            "<emoji document_id=5188377234380954537>💢</emoji> <b>Shaxsiy लॉग</b>"
            " </code>\n\n<emoji document_id=5454390891466726015>👋</emoji>"
            " <b>Shaxsiy संस्करण: {}.{}.{}</b>{}\n<Emoji"
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            loader.ConfigValue(
                ...
                " logs from TestModule. If this option is enabled, Shaxsiy will send all"
    ...
    @loader.command(
        ...
        uz_doc=(
            "[modul] - Dasturchilar uchun: modulni debug rejimida ochib, va uni"
    ...
    async def client_ready(self):
        chat, _ = await utils.asset_channel(
            self._client,
            "shaxsiy-logs",
            "🔰 Sizning Shaxsiy Userbot jurnallaringiz ushbu chatda paydo bo'ladi",
            silent=True,
            invite_bot=True,
        ...
        logger.debug("%s uchun bot jurnali oʻrnatildi", self._logchat)
