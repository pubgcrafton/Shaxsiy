...
from ..log import ShaxsiyException
...
class PythonMod(loader.Module):
    ...
    async def e(self, message: Message):
        ...
        try:
            ...
            item = ShaxsiyException.from_exc_info(*sys.exc_info())
            exc = (
                "\n<b>🪐 To'liq to'plam:</b>\n\n"
            ...
            exc = exc.replace(str(self._client.shaxsiy_me.phone), "📵")
        ...
        ret = ret.replace(str(self._client.shaxsiy_me.phone), "📵")
