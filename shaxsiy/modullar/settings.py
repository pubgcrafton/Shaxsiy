...
class CoreMod(loader.Module):
    ...
    strings_uz = {
        ...
        "delalias_args": (
            "<emoji document_id=5436162517686557387>🚫</emoji> <b>Ism kerak taxallus</b>"
        ),
        "alias_removed": (
        ...
        "shaxsiy": (
            ...
            " <b>Yaratish: </b><i>{}</i>\n\n<emoji"
            " document_id=5233346091725888979>⚙️</emoji> <b>Shaxsiy-TL:"
            " </b><i>{}</i>\n\n<emojidocument_id=5454182070156794055>⌨️</emoji>"
            " <b>Ishlab chiquvchi: t.me/DONIYOR_TM</b>"
        ),
        ...
        "who_to_unblacklist": (
            "<emoji document_id=5384612769716774600>❓</emoji> <b>Keyin kimni blokdan"
            " chiqarish kerak?</b>"
        ),
        "unstable": (
    ...
    strings_es = {
        ...
        "shaxsiy": (
            ...
            " document_id=5233346091725888979>⚙️</emoji> <b>Shaxsiy-TL:"
            " </b><i>{}</i>\n\n<emojidocument_id=5454182070156794055>⌨️</emoji>"
            " <b>Desarrollador: t.me/DONIYOR_TM</b>"
        ),
    ...
    @loader.command(
        ru_doc="Показать версию Shaxsiy",
        de_doc="Zeige die Shaxsiy-Version an",
        tr_doc="Shaxsiy sürümünü gösterir",
        uz_doc="Shaxsiy Userbot versiyasini ko'rsatish",
        hi_doc="Shaxsiy का संस्करण दिखाएं",
        ja_doc="Shaxsiyのバージョンを表示します",
        kr_doc="Shaxsiy 버전을 표시합니다",
        ar_doc="إظهار إصدار Shaxsiy",
        es_doc="Mostrar la versión de Shaxsiy",
    )
    async def shaxsiycmd(self, message: Message):
        """Get Shaxsiy version"""
        await utils.answer(
            message,
            self.strings("shaxsiy").format(
                (
    ...
    @loader.command(
        ...
        uz_doc="<avvalgi> - Buyruqlar uchun avvalgisini belgilash",
    ...
    @loader.command(
        ...
        uz_doc="Taxalluslarni ko'rsatish",
    ...
    @loader.command(
        ...
        uz_doc="Buyrug' uchun taxallus belgilash",
    ...
    @loader.command(
        ...
        uz_doc="Buyrug' uchun taxallusni o'chirish",
