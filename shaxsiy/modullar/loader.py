...
class LoaderMod(loader.Module):
    ...
    strings = {
        ...
        "inline_init_failed": (
            ...
            " Shaxsiy inline feature and initialization of InlineManager"
    ...
    strings_ru = {
        ...
        "inline_init_failed": (
            ...
            " ShaxsiyInline, а инициализация менеджера инлайна неудачна</b>\n<i>Попробуй"
    ...
    strings_de = {
        ...
        "inline_init_failed": (
            ...
            " Initialisierung von ShaxsiyInline und Inline-Manager"
    ...
    strings_tr = {
        ...
        "inline_init_failed": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Bu modül Shaxsiy satır"
        ...
        "version_incompatible": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Bu modül Shaxsiy {}"
            " sürümünü gerektirmektedir.+\nLütfen, </b><code>.update</code> kodu ile"
            " Shaxsiy'yı güncelleyin"
        ),
        "ffmpeg_required": (
    ...
    strings_uz = {
        ...
        "version_incompatible": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Ushbu modulga Shaxsiy Userbot"
        ...
        "save": "💿 Saqlash",
        "no_save": "🚫 Kerakmas",
        "save_for_all": "💽 Har vaqtda saqlash",
        "never_save": "🚫 Hech qachon saqlamaslik",
        "will_save_fs": (
            "💽 Endi fayldan yuklangan barcha modullar qattiq diskda saqlanadi"
        ),
        "inline_init_failed": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Ushbu modulga kerak"
            " ShaxsiyInline va inline menejeri ishga tushirilmadi</b>\n<i>Sinab"
        ...
        "overwrite_module": (
            ...
            " (</b><code>{}</code><b>)</b>\n\n<emojidocument_id=5472146462362048818>💡</emoji><i>"
            " Bu xato emas, balki o'lchov O'rnatilgan modullarni almashtirishni oldini"
        ...
        "overwrite_command": (
            ...
            " (</b><code>{}</code><b>)</b>\n\n<emojidocument_id=5472146462362048818>💡</emoji><i>"
            " Bu xato emas, balki o'lchov O'rnatilgan buyruqlarni almashtirishni oldini"
            " olish uchun zarur bo'lgan xavfsizlik har xil keraksiz narsalarga ega"
            " modullar. Bu haqida qo'llab-quvvatlash chatida xabar bermang</i>"
        ),
        "unload_core": (
    ...
    strings_ja = {
        ...
        "inline_init_failed": (
            ...
            "Shaxsiy インライン機能と InlineManager の初期化"
    ...
    strings_kr = {
        ...
        "inline_init_failed": (
            ...
            " Shaxsiy 인라인 기능 및 InlineManager 초기화"
    ...
    strings_ar = {
        ...
        "inline_init_failed": (
            ...
            " تتطلب وجود Shaxsiy inline وفشلت"
    ...
    strings_es = {
        ...
        "inline_init_failed": (
            ...
            " requiere la existencia de Shaxsiy inline y falló"
    ...
    @loader.command(
        ...
        uz_doc="Rasmiy repodan modulni yuklash",
    ...
    async def _send_stats(self, url: str, retry: bool = False):
        """Send anonymous stats to Shaxsiy"""
        try:
            ...
            res = await utils.run_sync(
                ...
                data={"url": url},
                headers={"X-Shaxsiy-Token": self.get("token")},
            )
    ...
    async def load_module(
        ...
        module_name = f"shaxsiy.modules.{uid}"
        ...
        try:
            try:
                ...
                async def inner_proxy():
                    ...
                    while True:
                        if hasattr(instance, "shaxsiy_wait_channel_approve"):
                            if message:
                                (
                                    module,
                                    channel,
                                    reason,
                                ) = instance.shaxsiy_wait_channel_approve
        ...
        instance.shaxsiy_meta_pic = next(
            (
        ...
        try:
            if developer in self._client._shaxsiy_entity_cache and getattr(
