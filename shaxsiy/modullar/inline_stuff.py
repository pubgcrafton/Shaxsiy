...
class InlineStuffMod(loader.Module):
    ...
    strings = {
        ...
        "this_is_shaxsiy": (
            "🔆 <b>Hi! This is Shaxsiy — powerful modular Telegram userbot. You can"
    ...
    strings_de = {
        ...
        "this_is_shaxsiy": (
            "🔆 <b>Hallo! Das ist Shaxsiy — mächtiger modulare Telegram Userbot. Du kannst"
    ...
    strings_tr = {
        ...
        "this_is_shaxsiy": (
            "🔆 <b>Merhaba! Bu Shaxsiy — güçlü modüler Telegram kullanıcı botu. Hesabınıza"
    ...
    strings_hi = {
        ...
        "this_is_shaxsiy": (
            "🔆 <b>नमस्ते! यह Shaxsiy है — एक मजबूत और मॉड्यूलर टेलीग्राम यूजरबॉट। आप इसे"
    ...
    strings_uz = {
        ...
        "this_is_shaxsiy": (
            "🔆 <b>Salom! Bu Shaxsiy Userbot - kuchli modulli Telegram userboti. Siz uni"
    ...
    strings_ja = {
        ...
        "this_is_shaxsiy": (
            "🔆 <b>こんにちは！これはShaxsiyです — 力強いモジュール式のTelegramユーザーボットです。"
    ...
    strings_kr = {
        ...
        "this_is_shaxsiy": (
            "🔆 <b>안녕하세요! 이것은 Shaxsiy입니다 — 강력하고 모듈식인 Telegram 사용자 봇입니다."
    ...
    strings_ar = {
        ...
        "this_is_shaxsiy": (
            "🔆 <b>مرحبًا! هذا هو Shaxsiy - مستخدم بوت تيليغرام قوي وموديولي. يمكنك تثبيته"
            " على حسابك!</b>\n\n<b>🌍 <a"
            ' href="https://github.com/pubgcrafton/Shaxsiy">GitHub</a></b>\n<b>👥 <a'
    ...
    strings_es = {
        ...
        "this_is_shaxsiy": (
            "🔆 <b>¡Hola! Este es Shaxsiy - un poderoso bot de usuario modular de"
    ...
    async def ch_shaxsiy_bot(self, message: Message):
        """<username> - Change your Shaxsiy inline bot username"""
        ...
        self._db.set("shaxsiy.inline", "custom_bot", args)
        self._db.set("shaxsiy.inline", "bot_token", None)
