...
class UpdaterMod(loader.Module):
    ...
    strings = {
        ...
        "update_confirm": (
            "❓ <b>Are you sure you"
            " want to update?\n\n<a"
            ' href="https://github.com/pubgcrafton/Shaxsiy/commit/{}">{}</a> ⤑ <a'
            ' href="https://github.com/pubgcrafton/Shaxsiy/commit/{}">{}</a></b>'
        ),
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            loader.ConfigValue(
                "GIT_ORIGIN_URL",
                "https://github.com/pubgcrafton/Shaxsiy",
    ...
    async def restart_common(
        ...
        msg_obj = await utils.answer(
            ...
            self.strings("restarting_caption").format(
                ...
                if self._client.shaxsiy_me.premium
                and CUSTOM_EMOJIS
    ...
    async def _add_folder(self):
        ...
        if any(getattr(folder, "title", None) == "shaxsiy" for folder in folders):
            return
        ...
        try:
            ...
            logger.critical(
                "Can't create Shaxsiy folder. Possible reasons are:\n"
