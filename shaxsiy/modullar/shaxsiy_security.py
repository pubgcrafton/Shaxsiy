...
class ShaxsiySecurityMod(loader.Module):
    ...
    strings_uz = {
        "global": (
            "🔐 <b>Bu yerda siz global chegaralash maskasini ta'hrirlashingiz mumkin."
            " Agar bu yerda ruxsat berilmasa, qolgan joylarda ham ruxsat berilmaydi!</b>"
        ),
        "warning": (
            '⚠️ <b>Iltimos, ta\'sdiqlang, siz <a href="tg://user?id={}">{}</a>'
            " </b><code>{}</code><b> ega gruppasiga qo'shmoqchimisiz? Bu harakat shaxsiy"
