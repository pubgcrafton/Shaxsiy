...
class HelpMod(loader.Module):
    ...
    strings = {
        ...
        "undoc_cmd": "🦥 No docs",
        "all_header": (
            "<emoji document_id=5188377234380954537>🏕️</emoji> <b>{} mods available,"
            " {} hidden:</b>"
        ),
        "mod_tmpl": "\n{} <code>{}</code>",
        "first_cmd_tmpl": ": ( {}",
        ...
        "support": (
            "{} <b>Link to </b><a href='https://t.me/shaxsiy_guruh_007'>support chat</a></b>"
        ),
        "partial_load": (
        ...
        "request_join": "You requested link for Shaxsiy support chat",
        "core_notice": (
    ...
    strings_ru = {
        ...
        "support": (
            "{} <b>Ссылка на </b><a href='https://t.me/shaxsiy_guruh_007'>чат помощи</a></b>"
        ),
        ...
        "request_join": "Вы запросили ссылку на чат помощи Shaxsiy",
        "core_notice": (
    ...
    strings_de = {
        ...
        "all_header": (
            "<emoji document_id=5188377234380954537>🏕️</emoji> <b>{} Module verfügbar,"
            " {} versteckt:</b>"
        ),
        "mod_tmpl": "\n{} <code>{}</code>",
        "first_cmd_tmpl": ": ( {}",
        ...
        "support": (
            "{} <b>Link zum </b><a href='https://t.me/shaxsiy_guruh_007'>Supportchat</a></b>"
        ),
    ...
    strings_tr = {
        ...
        "all_header": (
            "<emoji document_id=5188377234380954537>🏕️</emoji> <b>{} adet modül mevcut,"
            " {} gizli:</b>"
        ),
        "mod_tmpl": "\n{} <code>{}</code>",
        "first_cmd_tmpl": ": ( {}",
        ...
        "support": "{} <b><a href='https://t.me/shaxsiy_guruh_007'>Destek sohbeti</a></b>",
        ...
        "request_join": "Shaxsiy Destek sohbetinin davet bağlantısını istediniz",
        "core_notice": (
    ...
    strings_hi = {
        ...
        "all_header": (
            "<emoji document_id=5188377234380954537>🏕️</emoji> <b>{} मॉड्यूल उपलब्ध हैं,"
            " {} छिपा हुआ:</b>"
        ),
        "mod_tmpl": "\n{} <code>{}</code>",
        "first_cmd_tmpl": ": ( {}",
        ...
        "support": "{} <b><a href='https://t.me/shaxsiy_guruh_007'>सपोर्ट चैट</a></b>",
    ...
    strings_uz = {
        ...
        "first_cmd_tmpl": ": ( {}",
        "cmd_tmpl": " | {}",
        "no_mod": "🚫 <b>Yashirish uchun modulni kiriting</b>",
        "hidden_shown": (
        ...
        "support": "{} <b><a href='https://t.me/shaxsiy_guruh_007'>Yordam chati</a></b>",
        ...
        "request_join": "Siz qo'llab-quvvatlash chati havolasini so'radingiz",
        "core_notice": (
            "<emoji document_id=5472105307985419058>☝️</emoji> <b>Bu bir qo'shimcha"
            " modul, uni o'chirib yoki o'zgartirib bo'lmaydi</b>"
        ),
    }
    ...
    strings_ja = {
        ...
        "all_header": (
            "<emoji document_id=5188377234380954537>🏕️</emoji> <b>{} モジュールの総数,"
            " 隠された {}:</b>"
        ),
        "mod_tmpl": "\n{} <code>{}</code>",
        "first_cmd_tmpl": ": ( {}",
        ...
        "support": "{} <b><a href='https://t.me/shaxsiy_guruh_007'>サポートチャット</a></b>",
    ...
    strings_kr = {
        ...
        "undoc_cmd": "🦥 문서화되지 않음",
        "all_header": (
            "<emoji document_id=5188377234380954537>🏕️</emoji> <b>{} 총 모듈, 숨겨진 {}:</b>"
        ),
        "mod_tmpl": "\n{} <code>{}</code>",
        "first_cmd_tmpl": ": ( {}",
        "cmd_tmpl": " | {}",
        ...
        "support": "{} <b><a href='https://t.me/shaxsiy_guruh_007'>지원 채팅</a></b>",
    ...
    strings_ar = {
        ...
        "all_header": (
            "<emoji document_id=5188377234380954537>🏕️</emoji> <b>{} موديولات,"
            " {} مخفية:</b>"
        ),
        "mod_tmpl": "\n{} <code>{}</code>",
        "first_cmd_tmpl": ": ( {}",
        ...
        "support": "{} <b><a href='https://t.me/shaxsiy_guruh_007'>دردشة الدعم</a></b>",
    ...
    strings_es = {
        ...
        "all_header": (
            "<emoji document_id=5188377234380954537>🏕️</emoji> <b>{} módulos,"
            " {} ocultos:</b>"
        ),
        "mod_tmpl": "\n{} <code>{}</code>",
        "first_cmd_tmpl": ": ( {}",
        ...
        "support": "{} <b><a href='https://t.me/shaxsiy_guruh_007'>Chat de soporte</a></b>",
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            ...
            loader.ConfigValue(
                "shaxsiy_emoji",
                "🧑‍🎤",
                lambda: "Shaxsiy-only module bullet",
                validator=loader.validators.Emoji(length=1),
            ),
            loader.ConfigValue(
                "plain_emoji",
    ...
    @loader.command(
        ...
        uz_doc=(
            "<modul yoki modullar> - Modul(-lar) helpdan yashirish\n*Modullarni"
    ...
    @loader.command(
        ...
        uz_doc="[modul] [-f] - Helpni ko'rsatish",
    ...
    @loader.command(
        ru_doc="Показать ссылку на чат помощи Shaxsiy",
        de_doc="Zeige den Link zum Shaxsiy-Hilfe-Chat",
        tr_doc="Shaxsiy yardım sohbetinin bağlantısını göster",
        uz_doc="Shaxsiy Userbot yordam suhbatining havolasini ko'rsatish",
        ...
        es_doc="Mostrar enlace al chat de ayuda de Shaxsiy",
    )
    async def support(self, message):
        """Get link of Shaxsiy support chat"""
        if message.out:
            await self.request_join("@shaxsiy_guruh_007", self.strings("request_join"))
        ...
        await utils.answer(
            ...
            self.strings("support").format(
                (
                    ...
                    if self._client.shaxsiy_me.premium and CUSTOM_EMOJIS
                    else "🔆"
                )
            ),
        )
