...
class UpdateNotifierMod(loader.Module):
    """Tracks latest Shaxsiy releases, and notifies you, if update is required"""

    strings = {
        "name": "UpdateNotifier",
        "update_required": (
            "💢 <b>Shaxsiy Userbot Update available!</b>\n\nNew Shaxsiy version released.\n🔮"
            " <b>Shaxsiy <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 And {} more...</b></i>",
    ...
    strings_ru = {
        "update_required": (
            "💢 <b>Доступно обновление Shaxsiy!</b>\n\nОпубликована новая версия Shaxsiy.\n🔮"
            " <b>Shaxsiy <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 И еще {}...</b></i>",
    ...
    strings_de = {
        "update_required": (
            "💢 <b>Shaxsiy Update verfügbar!</b>\n\nNeue Shaxsiy Version veröffentlicht.\n🔮"
            " <b>Shaxsiy <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 Und {} mehr...</b></i>",
    ...
    strings_hi = {
        "update_required": (
            "💢 <b>कस्टम Userbot अपडेट उपलब्ध है!</b>\n\nनया कस्टम Userbot संस्करण आ गया है"
            " है।\n🔮 <b>निजी <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 और {} अधिक...</b></i>",
    ...
    strings_uz = {
        "update_required": (
            "💢 <b>Shaxsiy Userbot yangilanishi mavjud!</b>\n\nYangi Shaxsiy Userbot versiyasi chiqdi.\n🔮"
            " <b>Shaxsiy Userbot <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 Va {} boshqa...</b></i>",
    ...
    strings_tr = {
        "update_required": (
            "💢 <b>Shaxsiy güncellemesi mevcut!</b>\n\nYeni bir Shaxsiy sürümü"
            " yayınlandı.\n🔮 <b>Shaxsiy <s>{}</s> -> {}</b>\n\n{}"
        ),
    ...
    strings_kr = {
        "update_required": (
            "💢 <b>Shaxsiy 업데이트가 있습니다!</b>\n새로운 Shaxsiy 버전이 출시되었습니다.\n🔮 <b>Shaxsiy <s>{}</s>"
            " -> {}</b>\n{}"
        ),
        "more": "\n<i><b>🎥 그리고 {} 더...</b></i>",
    ...
    strings_ar = {
        "update_required": (
            "💢 <b>يوجد تحديث لـ Shaxsiy!</b>\n\nتم إصدار إصدار جديد من Shaxsiy.\n🔮"
            " <b>Shaxsiy <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 و {} أكثر...</b></i>",
    ...
    strings_es = {
        "update_required": (
            "💢 <b>¡Actualización de Shaxsiy disponible!</b>\n\nSe ha publicado una nueva"
            " versión de Shaxsiy.\n🔮 <b>Shaxsiy <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 Y {} más...</b></i>",
    ...
    async def client_ready(self):
        ...
        self._markup = lambda: self.inline.generate_markup(
            [
                {"text": self.strings("update"), "data": "shaxsiy_update"},
                {"text": self.strings("ignore"), "data": "shaxsiy_upd_ignore"},
            ]
        )
        ...
        if self._pending not in [utils.get_git_hash(), self._notified]:
            m = await self.inline.bot.send_message(
                ...
                self.strings("update_required").format(
                    ...
                    '<a href="https://github.com/pubgcrafton/Shaxsiy/compare/{}...{}">{}</a>'
                    .format(
    ...
    async def update(self, call: InlineCall):
        ...
        if call.data not in {"shaxsiy_update", "shaxsiy_upd_ignore"}:
            return

        if call.data == "shaxsiy_upd_ignore":
