...
@loader.tds
class ShaxsiySettingsMod(loader.Module):
    ...
    strings = {
        ...
        "inline_settings": "⚙️ <b>Here you can configure your Shaxsiy settings</b>",
        "confirm_update": (
        ...
        "nonick_warning": (
            ...
            "You may get muted in Shaxsiy chats. Change prefix or "
            "disable NoNick!"
        ),
        "reply_required": (
        ...
        "deauth_confirm": (
            "⚠️ <b>This action will fully remove Shaxsiy from this account and can't be"
            " reverted!</b>\n\n<i>- Shaxsiy chats will be removed\n- Session will be"
            " terminated and removed\n- Shaxsiy inline bot will be removed</i>"
        ),
        "deauth_confirm_step2": (
            "⚠️ <b>Are you really sure you want to delete Shaxsiy?</b>"
        ),
        "deauth_yes": "I'm sure",
        ...
        "uninstall": "😢 <b>Uninstalling Shaxsiy...</b>",
        "uninstalled": (
            "😢 <b>Shaxsiy uninstalled. Web interface is still active, you can add another"
            " account</b>"
        ),
        ...
        "privacy_leak": (
            "⚠️ <b>This command gives access to your Shaxsiy web interface. It's not"
        ...
        "opening_tunnel": "🔁 <b>Opening tunnel to Shaxsiy web interface...</b>",
        "tunnel_opened": "🎉 <b>Tunnel opened. This link is valid for about 1 hour</b>",
        "web_btn": "🌍 Web interface",
        "btn_yes": "🚸 Open anyway",
        "btn_no": "🔻 Cancel",
        "lavhost_web": (
            "✌️ <b>This link leads to your Shaxsiy web interface on lavHost</b>\n\n<i>💡"
    ...
    strings_ru = {
        ...
        "inline_settings": "⚙️ <b>Здесь можно управлять настройками Shaxsiy</b>",
        ...
        "_cls_doc": "Дополнительные настройки Shaxsiy",
        "nonick_warning": (
            "Внимание! Ты включил NoNick со стандартным префиксом! "
            "Тебя могут замьютить в чатах Shaxsiy. Измени префикс или "
        ...
        "deauth_confirm": (
            "⚠️ <b>Это действие полностью удалит Shaxsiy с этого аккаунта! Его нельзя"
            " отменить</b>\n\n<i>- Все чаты, связанные с Shaxsiy будут удалены\n- Сессия"
            " Shaxsiy будет сброшена\n- Инлайн бот Shaxsiy будет удален</i>"
        ),
        "deauth_confirm_step2": "⚠️ <b>Ты точно уверен, что хочешь удалить Shaxsiy?</b>",
        "deauth_yes": "Я уверен",
        ...
        "uninstall": "😢 <b>Удаляю Shaxsiy...</b>",
        "uninstalled": (
            "😢 <b>Shaxsiy удалена. Веб-интерфейс все еще активен, можно добавить другие"
            " аккаунты!</b>"
        ),
        ...
        "privacy_leak": (
            "⚠️ <b>Эта команда дает доступ к веб-интерфейсу Shaxsiy. Ее выполнение в"
        ...
        "opening_tunnel": "🔁 <b>Открываю тоннель к веб-интерфейсу Shaxsiy...</b>",
        "tunnel_opened": (
        ...
        "btn_no": "🔻 Закрыть",
        "lavhost_web": (
            "✌️ <b>По этой ссылке ты попадешь в веб-интерфейс Shaxsiy на"
    ...
    strings_de = {
        ...
        "inline_settings": (
            "⚙️ <b>Hier können Sie Ihre Shaxsiy-Einstellungen verwalten</b>"
        ),
        "confirm_update": (
        ...
        "_cls_doc": "Erweiterte Shaxsiy-Einstellungen",
        "nonick_warning": (
            "Achtung! Sie haben NoNick mit dem Standard-Präfix eingefügt!Sie sind"
            " möglicherweise in Shaxsiy-Chats stummgeschaltet. Ändern Sie das Präfix oder"
        ...
        "deauth_confirm": (
            "⚠️ <b>Diese Aktion wird Shaxsiy vollständig von diesem Konto entfernen! Er"
            " kann nichtAbbrechen</b>\n\n<i>- Alle Shaxsiy-bezogenen Chats werden"
            " gelöscht\n- SitzungShaxsiy wird zurückgesetzt\n- Shaxsiys Inline-Bot wird"
            " gelöscht</i>"
        ),
        "deauth_confirm_step2": (
            "⚠️ <b>Sind Sie sicher, dass Sie Shaxsiy deinstallieren möchten?</b>"
        ),
        ...
        "uninstall": "😢 <b>Shaxsiy wird deinstalliert...</b>",
        "uninstalled": (
            "😢 <b>Shaxsiy wurde entfernt. Die Weboberfläche ist noch aktiv, andere können"
        ...
        "privacy_leak": (
            "⚠️ <b>Dieser Befehl ermöglicht den Zugriff auf die Shaxsiy-Weboberfläche."
        ...
        "opening_tunnel": "🔁 <b>Öffne einen Tunnel zur Shaxsiy-Weboberfläche...</b>",
        "tunnel_opened": (
        ...
        "btn_no": "🔻Schließen",
        "lavhost_web": (
            "✌️ <b>Dieser Link führt Sie zur Shaxsiy-Weboberfläche auf"
    ...
    strings_tr = {
        ...
        "inline_settings": "⚙️ <b>Buradan Shaxsiy ayarlarınızı yönetebilirsiniz</b>",
        "confirm_update": (
        ...
        "_cls_doc": "Gelişmiş Shaxsiy Ayarları",
        "nonick_warning": (
            "Dikkat! NoNick'i standart önekle eklediniz!"
            "Shaxsiy sohbetlerinde sesiniz kapatılmış olabilir. Ön eki değiştirin veya "
        ...
        "deauth_confirm": (
            "⚠️ <b>Bu işlem Shaxsiy'yı bu hesaptan tamamen kaldıracak! Yapamaz"
            "iptal</b>\n\n<i>- Shaxsiy ile ilgili tüm sohbetler silinecek\n- Oturum"
            " Shaxsiy sıfırlanacak\n- Shaxsiy'nın satır içi botu silinecek</i>"
        ),
        "deauth_confirm_step2": (
            "⚠️ <b>Shaxsiy'yı kaldırmak istediğinizden emin misiniz?</b>"
        ),
        "deauth_yes": "Eminim",
        ...
        "uninstall": "😢 <b>Shaxsiy'yı Kaldırılıyor...</b>",
        "uninstalled": (
            "😢 <b>Shaxsiy kaldırıldı. Web arayüzü hala aktif, başkaları eklenebilir"
            "hesaplar!</b>"
        ),
        ...
        "privacy_leak": (
            "⚠️ <b>Bu komut, Shaxsiy web arayüzüne erişim sağlar. YürütülmesiGenel"
        ...
        "privacy_leak_nowarn": (
            "⚠️ <b>Bu komut, Shaxsiy web arayüzüne erişim sağlar. Yürütülmesi"
    ...
    strings_uz = {
        ...
        "inline_settings": (
            "⚙️ <b>Bu yerda siz Shaxsiy Userbot sozlamalaringizni boshqarishingiz mumkin</b>"
        ),
        "confirm_update": (
        ...
        "_cls_doc": "Kengaytirilgan Shaxsiy Userbot sozlamalari",
        "nonick_warning": (
            "Diqqat! NoNickni standart prefiks bilan kiritdingiz! Shaxsiy Userbot chatlarida"
        ...
        "deauth_confirm": (
            "⚠️ <b>Bu amal Shaxsiy Userbotni ushbu hisobdan butunlay olib tashlaydi! U qila"
            " olmaydi. Bekor qilish</b>\n\n<i>- Shaxsiy Userbot bilan bog'liq barcha chatlar"
            " o'chiriladi\n- Sessiyada Shaxsiy Userbot qayta tiklanadi\n- Shaxsiy Userbotning ichki boti"
            " o'chiriladi</i>"
        ),
        "deauth_confirm_step2": (
            "⚠️ <b>Haqiqatan ham Shaxsiy Userbotni oʻchirib tashlamoqchimisiz?</b>"
        ),
        ...
        "uninstall": "😢 <b>Shaxsiy Userbot o'chirilmoqda...</b>",
        "uninstalled": (
            "😢 <b>Shaxsiy Userbot oʻchirildi. Veb-interfeys hali ham faol, boshqa hisoblarni qoʻshish"
            " mumkin!</b>"
        ),
        ...
        "privacy_leak": (
            "⚠️ <b>Ushbu buyruq Shaxsiy Userbot veb-interfeysiga kirish imkonini beradi. Uning"
            " bajarilishi Ommaviy chatlar xavfsizligiga xavf tug'diradi. Afzallikni bajaring"
        ...
        "privacy_leak_nowarn": (
            "⚠️ <b>Ushbu buyruq Shaxsiy Userbot veb-interfeysiga kirish imkonini beradi. Uning"
            " bajarilishi Ommaviy chatlar xavfsizligiga xavf tug'diradi. Afzal bajaring uni"
            " <a href='tg://openmessage?user_id={}'>Mazkur xabarlarda</a>.</b>"
        ),
        "opening_tunnel": "🔁 <b>Shaxsiy Userbot veb-interfeysiga tunnel ochilmoqda...</b>",
        "tunnel_opened": (
        ...
        "btn_no": "🔻 Yopish",
        "lavhost_web": (
            "✌️ <b>Ushbu havola sizni Shaxsiy Userbot veb-interfeysiga olib boradi"
            " lavHost</b>\n\n<i>💡 Hisob ma'lumotlaringizdan foydalanib tizimga"
            " kirishingiz kerak,lavHost</i>ni sozlashda ko'rsatilgan"
        ),
        "disable_stats": "✅ Anonim statistikaga ruxsat berildi",
    ...
    strings_ja = {
        ...
        "inline_settings": "⚙️ <b>ここで Shaxsiy の設定を管理できます</b>",
        ...
        "nonick_warning": (
            ...
            "Shaxsiy Chat でミュートすることができます。プレフィックスを変更するか, "
        ...
        "deauth_confirm": (
            "⚠️ <b>このアクションにより, このアカウントから Shaxsiy が完全に削除されます! 彼は削除できません"
            "キャンセル</b>\n\n<i>- Shaxsiy に関連するすべてのチャットが削除されます\n- セッション"
            "ヒッカはリセットされます\n- ヒッカのインライン ボットは削除されます</i>"
        ),
        "deauth_confirm_step2": "⚠️ <b>Shaxsiy をアンインストールしてもよろしいですか?</b>",
        "deauth_yes": "確かに",
        "deauth_no_1": "わからない",
        "deauth_no_2": "わかりません",
        "deauth_no_3": "いいえ",
        ...
        "uninstall": "😢 <b>Shaxsiy をアンインストールしています...</b>",
        "uninstalled": (
            "😢 <b>Shaxsiy' は廃止されました。Web インターフェースはまだアクティブです。その他アカウントを追加できます!</b>"
        ),
        ...
        "privacy_leak": (
            "⚠️ <b>このコマンドは, Shaxsiy Web インターフェイスへのアクセスを提供します。その実行"
        ...
        "btn_no": "閉じる",
        "lavhost_web": (
            "✌️ <b>このリンクをクリックすると, Shaxsiy Web インターフェイス lvHost に移動します</b>\n\n<i>💡"
    ...
    strings_kr = {
        ...
        "inline_settings": "⚙️ <b>여기에서 Shaxsiy 설정을 관리할 수 있습니다.</b>",
        ...
        "_cls_doc": "고급 Shaxsiy 설정",
        "nonick_warning": (
            "주의! 표준 접두사에 NoNick을 포함했습니다!Shaxsiy 채팅에서 음소거할 수 있습니다. 접두사를 변경하거나 글로벌 노닉 꺼!"
        ),
        "reply_required": (
        ...
        "deauth_confirm": (
            "⚠️ <b>이 작업은 이 계정에서 Shaxsiy를 완전히 제거합니다! 그는 할 수 없습니다."
            "취소</b>\n\n<i>- Shaxsiy와 관련된 모든 채팅이 삭제됩니다\n- 세션"
            " Shaxsiy가 재설정됩니다\n- Shaxsiy의 인라인 봇이 제거됩니다</i>"
        ),
        "deauth_confirm_step2": "⚠️ <b>Shaxsiy를 제거하시겠습니까?</b>",
        "deauth_yes": "확실합니다",
        ...
        "uninstalling": "😢 <b>Shaxsiy 제거 중...</b>",
        "uninstalled": (
            "😢 <b>Shaxsiy'는 더 이상 사용되지 않습니다. 웹 인터페이스는 여전히 활성화되어 있습니다. 계정을 추가할 수 있습니다!</b>"
        ),
        ...
        "privacy_leak": (
            "⚠️ <b>이 명령은 Shaxsiy 웹 인터페이스에 대한 액세스를 제공합니다. 실행"
        ...
        "btn_no": " 닫기",
        "lavhost_web": (
            "✌️ <b>이 링크는 Shaxsiy 웹 인터페이스 lvHost</b>로 이동합니다.\n\n<i>💡"
    ...
    strings_ar = {
        ...
        "inline_settings": "⚙️ <b> هنا يمكنك إدارة إعدادات Shaxsiy </b>",
        ...
        "_cls_doc": "إعدادات Shaxsiy المتقدمة",
        "nonick_warning": (
            "تنبيه! لقد قمت بتضمين NoNick مع البادئة القياسية!"
            "يمكن كتم ص, تك في Shaxsiy Chat. قم بتغيير البادئة أ, "
        ...
        "deauth_confirm": (
            "⚠️ <b> سيؤدي هذا الإجراء إلى إزالة Shaxsiy تمامًا من هذا الحساب! لا يمكنه"
            " ذلكإلغاء </b>\n\n<i> - سيتم حذف كافة الدردشات المتعلقة بهيكا\n-"
            " الجلسةستتم إعادة تعيين Shaxsiy\n- ستتم إزالة برنامج Shaxsiy المضمن </i>"
        ),
        "deauth_confirm_step2": "⚠️ <b> هل أنت متأكد من أنك تريد إزالة Shaxsiy؟ </b>",
        ...
        "uninstalling": "😢 <b> إزالة Shaxsiy ... </b>",
        "uninstalled": (
            "<b>تم إهمال  Shaxsiy. , اجهة ال, يب لا تزال نشطة ,  , البعض الآخر"
        ...
        "privacy_leak": (
            "⚠️ <b> ي, فر هذا الأمر ال, ص, ل إلى , اجهة , يب Shaxsiy. تنفيذه"
        ...
        "btn_no": "إغلاق",
        "lavhost_web": (
            "✌️ <b> سينقلك هذا الارتباط إلى , اجهة , يب Shaxsiy lvHost </b>\n\n<i> 💡"
    ...
    strings_es = {
        ...
        "inline_settings": (
            "⚙️ <b>Aquí puedes administrar la configuración de Shaxsiy</b>"
        ),
        ...
        "_cls_doc": "Configuración avanzada de Shaxsiy",
        "nonick_warning": (
            "¡Atención! ¡Has incluido NoNick con el prefijo estándar!"
            "Puedes silenciarte en Shaxsiy Chat. Cambia el prefijo o "
        ...
        "deauth_confirm": (
            "⚠️ <b>¡Esta acción eliminará completamente a Shaxsiy de esta cuenta! Él no"
            " puedeCancelar</b>\n\n<i>- Se eliminarán todos los chats relacionados con"
            " Shaxsiy\n- Sesión Shaxsiy se reiniciará\n- El bot en línea de Shaxsiy se"
            " eliminará</i>"
        ),
        "deauth_confirm_step2": (
            "⚠️ <b>¿Está seguro de que desea desinstalar Shaxsiy?</b>"
        ),
        ...
        "uninstall": "😢 <b>Desinstalando Shaxsiy...</b>",
        "uninstalled": (
            "😢 <b>Shaxsiy' ha quedado obsoleto. La interfaz web todavía está activa,"
        ...
        "privacy_leak": (
            "⚠️ <b>Este comando proporciona acceso a la interfaz web de Shaxsiy. Su"
        ...
        "btn_no": "Cerrar",
        "lavhost_web": (
            "✌️ <b>Este enlace lo llevará a la interfaz web de Shaxsiy lvHost</b>\n\n<i>💡"
    ...
    @loader.owner
    @loader.command(
        ru_doc="Удалить Shaxsiy",
        de_doc="Shaxsiy deinstallieren",
        tr_doc="Shaxsiy'yı kaldır",
        uz_doc="Shaxsiy Userbotni o'chirish",
        hi_doc="हिक्का को अनइंस्टॉल करें",
        ja_doc="Shaxsiyをアンインストールします",
        kr_doc="Shaxsiy를 제거합니다",
        ar_doc="إلغاء تثبيت هيكا",
        es_doc="Desinstalar Shaxsiy",
    )
    async def uninstall_shaxsiy(self, message: Message):
        """Uninstall Shaxsiy"""
    ...
    @loader.command(
        ...
        uz_doc="<module> - Joriy suhbatda ko'rib chiqqanlarni yoqish/o'chirish",
    ...
    async def inline__restart(
        ...
        await call.answer("Sizning userbotingiz qayta ishga tushirilmoqda...", show_alert=True)
        await call.delete()
    ...
    @loader.owner
    @loader.command(
        ru_doc="Открыть тоннель к веб-интерфейсу Shaxsiy",
        de_doc="Öffne einen Tunnel zum Shaxsiy Webinterface",
        tr_doc="Shaxsiy Web Arayüzüne bir tünel aç",
        uz_doc="Shaxsiy Userbot veb-interfeysi uchun tunel ochish",
        hi_doc="Shaxsiy वेब इंटरफ़ेस के लिए ट्यूनल खोलें",
        ja_doc="Shaxsiy Webインターフェイスにトンネルを開く",
        kr_doc="Shaxsiy 웹 인터페이스에 터널 열기",
        ar_doc="افتح نفقًا إلى واجهة Shaxsiy الويب",
        es_doc="Abrir un túnel al interfaz web de Shaxsiy",
    )
    async def weburl(self, message: Message, force: bool = False):
        """Opens web tunnel to your Shaxsiy web interface"""
        if "LAVHOST" in os.environ:
            form = await self.inline.form(
                ...
                reply_markup={
                    ...
                    "url": await main.shaxsiy.web.get_url(proxy_pass=False),
                },
        ...
        url = await main.shaxsiy.web.get_url(proxy_pass=True)
    ...
    async def invoke(self, message: Message):
        ...
        if module == "core":
            if method == "clear_entity_cache":
                result = (
                    f"Dropped {len(self._client._shaxsiy_entity_cache)} cache records"
                )
                self._client._shaxsiy_entity_cache = {}
            elif method == "clear_fulluser_cache":
                result = (
                    f"Dropped {len(self._client._shaxsiy_fulluser_cache)} cache records"
                )
                self._client._shaxsiy_fulluser_cache = {}
            elif method == "clear_fullchannel_cache":
                result = (
                    f"Dropped {len(self._client._shaxsiy_fullchannel_cache)} cache"
                    " records"
                )
                self._client._shaxsiy_fullchannel_cache = {}
            elif method == "clear_perms_cache":
                result = f"Dropped {len(self._client._shaxsiy_perms_cache)} cache records"
                self._client._shaxsiy_perms_cache = {}
            elif method == "clear_cache":
                result = (
                    f"Dropped {len(self._client._shaxsiy_entity_cache)} entity cache"
                    " records\nDropped"
                    f" {len(self._client._shaxsiy_fulluser_cache)} fulluser cache"
                    " records\nDropped"
                    f" {len(self._client._shaxsiy_fullchannel_cache)} fullchannel cache"
                    " records"
                )
                self._client._shaxsiy_entity_cache = {}
                self._client._shaxsiy_fulluser_cache = {}
                ...
                result = (
                    "Entity cache:"
                    f" {len(self._client._shaxsiy_entity_cache)} records\nFulluser cache:"
                    f" {len(self._client._shaxsiy_fulluser_cache)} records\nFullchannel"
                    f" cache: {len(self._client._shaxsiy_fullchannel_cache)} records"
                )
