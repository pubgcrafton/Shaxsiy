...
@loader.tds
class ShaxsiyInfoMod(loader.Module):
    """Show userbot info"""
    ...
    strings = {
        ...
        "desc": (
            ...
            ' href="https://github.com/pubgcrafton/Shaxsiy">GitHub</a>'
        ),
    }
    ...
    strings_uz = {
        ...
        "_cfg_banner": "URL uchun rasm",
        "setinfo_no_args": (
            "<emoji document_id=5370881342659631698>😢</emoji> <b>Ma'lumotni"
            " o'zgartirish uchun matnni kiriting</b>"
        ),
        "setinfo_success": (
        ...
        "desc": (
            "<emoji document_id=6318565919471699564>🌌</emoji> <b>Shaxsi Userbot</b>\n\nKo'p"
            ...
            ' href="https://github.com/pubgcrafton/Shaxsiy">GitHub</a> da misollarni'
            " ko'rishingiz mumkin"
        ),
    }
    ...
    strings_tr = {
        ...
        "desc": (
            "<emoji document_id=6318565919471699564>🌌</emoji> <b>Shaxsiy</b>\n\\Çok fazla"
            ...
            ' href="https://github.com/pubgcrafton/Shaxsiy">GitHub\'ı ziyaret'
            " edebilirsin</a>"
        ),
    }
    ...
    strings_ja = {
        ...
        "desc": (
            ...
            ' href="https://github.com/pubgcrafton/Shaxsiy">GitHub</a>を参照してください'
        ),
    }
    ...
    strings_kr = {
        ...
        "desc": (
            ...
            ' href="https://github.com/pubgcrafton/Shaxsiy">GitHub</a>를 참조하십시오'
        ),
    }
    ...
    strings_ar = {
        ...
        "desc": (
            ...
            ' زيارة <a href="https://github.com/pubgcrafton/Shaxsiy">GitHub</a>'
        ),
    }
    ...
    async def client_ready(self):
        ...
        if (
            ...
            == "https://siasky.net/LADIoU-z6hMtlcr7dYFLjn6hii2o_9lCqH5e_PChscRRbw"
        ):
            self.config[
                "banner_url"
            ] = "https://0x0.st/oxs-.jpg"
    ...
    def _render_info(self, inline: bool) -> str:
        ...
        return (
            (
                "<b>💢 Shaxsiy Userbot</b>\n"
                if "shaxsiy" not in self.config["custom_message"].lower()
                else ""
            )
            ...
            if self.config["custom_message"]
                ...
                *map(
                    ...
                    (
                        ...
                        if self._client.shaxsiy_me.premium and not inline
                        else "💢 Shaxsiy Userbot",
    ...
    async def info(self, _: InlineQuery) -> dict:
        ...
        return {
            ...
            **(
            ...
            "thumb": (
                "https://github.com/pubgcrafton/Shaxsiy/raw/master/assets/shaxsiy_pfp.png"
            ),
    ...
    async def shaxsiyinfocmd(self, message: Message):
        """Send info aka 'What is Shaxsiy?'"""
