...
class InlineManager(
    ...
    def __init__(
        ...
        self._token = db.get("shaxsiy.inline", "bot_token", False)
    ...
    async def _register_manager(
        ...
        self._name = get_display_name(self._client.shaxsiy_me)
        ...
        try:
            m = await self._client.send_message(self.bot_username, "/start shaxsiy init")
            ...
            try:
                m = await self._client.send_message(
                    self.bot_username, "/start shaxsiy init"
                )
            except Exception:
