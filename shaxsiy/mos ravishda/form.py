...
class Form(InlineUnit):
    async def form(
        ...
        reply_markup: typing.Optional[ShaxsiyReplyMarkup] = None,
        *,
        force_me: bool = False,
            ...
            await inline_query.answer(
                [
                    InlineQueryResultAudio(
                        ...
                        caption=form.get("text"),
                        parse_mode="HTML",
                        title=form["audio"].get("title", "Shaxsiy"),
