...
printf "\n\e[1;35;47m               █▀█ █          \e[0m"
printf "\n\e[1;35;47m                                   \e[0m"
printf "\n\n\e[3;34;40m Userbot o'rnatilmoqda...\e[0m\n\n"

##############################################################################

printf "\r\033[0;34mO'rnatishga tayyorgarlik ko'rilmoda...\e[0m"
...
echo "O'rnatilmoqda..." >shaxsiy-install.log
...
printf "\n\r\033[0;34mRepo nusxalanmoqda...\e[0m"
...
runout ${SUDO_CMD}git clone https://github.com/pubgcrafton/Shaxsiy/ || {
	errorout "Nusxalash amalga oshmadi."
	exit 3
}
cd Shaxsiy || {
...
printf "\r\033[K\033[0;32mRepo nusxalandi!\e[0m"
